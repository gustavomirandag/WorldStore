...
using WorldStore.Microservices.IamMicroservice.STS.Identity.Configuration.ApplicationParts;
using WorldStore.Microservices.IamMicroservice.STS.Identity.Configuration.Constants;
using WorldStore.Microservices.IamMicroservice.STS.Identity.Configuration.Interfaces;
using WorldStore.Microservices.IamMicroservice.STS.Identity.Helpers.Localization;
using WorldStore.Microservices.IamMicroservice.STS.Identity.Services;
using System.Linq;
...
namespace WorldStore.Microservices.IamMicroservice.STS.Identity.Helpers
{
