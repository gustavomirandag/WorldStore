...
namespace WorldStore.Microservices.OrderMicroservice.Infra.DataAccess.Migrations
{
    ...
    [Migration("20200828024834_init-order-microservice2")]
    partial class initordermicroservice2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorldStore.Microservice.OrderMicroservice.Domain.AggregatesModel.OrderAggregate.OrderItem", b =>
                {
                    b.HasOne("WorldStore.Microservice.OrderMicroservice.Domain.AggregatesModel.OrderAggregate.Order", "Order")
                        .WithMany("OrderItems")
