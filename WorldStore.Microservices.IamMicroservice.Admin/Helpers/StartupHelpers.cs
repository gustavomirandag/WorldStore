...
using WorldStore.Microservices.IamMicroservice.Admin.ExceptionHandling;
using WorldStore.Microservices.IamMicroservice.Admin.Configuration;
using WorldStore.Microservices.IamMicroservice.Admin.Configuration.ApplicationParts;
using WorldStore.Microservices.IamMicroservice.Admin.Configuration.Constants;
using WorldStore.Microservices.IamMicroservice.Admin.Configuration.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories;
using Skoruba.IdentityServer4.Admin.EntityFramework.Repositories.Interfaces;
using WorldStore.Microservices.IamMicroservice.Admin.Helpers.Localization;
using System.Linq;
using WorldStore.Microservices.IamMicroservice.Admin.EntityFramework.MySql.Extensions;
using WorldStore.Microservices.IamMicroservice.Admin.EntityFramework.Shared.Configuration;
using WorldStore.Microservices.IamMicroservice.Admin.EntityFramework.SqlServer.Extensions;
using WorldStore.Microservices.IamMicroservice.Admin.EntityFramework.PostgreSQL.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace WorldStore.Microservices.IamMicroservice.Admin.Helpers
{
